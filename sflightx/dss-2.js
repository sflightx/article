        ...
        children: [
            {
                ...
                content: "After months of unfavorable weather conditions, sFlightX is targeting to launch the RTF Mission One at Launch Complex 3A, Bataan Space Center, Philippines. The vehicle and ground infrastructure are ready for launch, pending regulatory approval."
            },
            {
                type: "p",
                class: "md-typescale-body-large",
                content: "This mission, counts as sFlightX's 16th orbital launch attempt and 15th launch of 2024. Numerous upgrades both vehicle and pad are observable, as we take step towards rapid reusability of Maya vehicles."
            },
            {
                type: "p",
                class: "md-typescale-body-large",
                content: "This flight will debut this flight. After executing a short period of entry burn ~30 seconds, the first stage booster will attempt propulsive landing below 2km AGL (Altitude at Ground Level). All 13 engines will relight during the landing burn. When reaches pre-determined altitude based on environment conditions, all engines cuts off but the and 3 center engines will continue the landing phase as the landing legs deploy."
            },
            {
                type: "h3",
